...
SENSORS: dict[str, tuple[SmartLifeSensorEntityDescription, ...]] = {
    ...
    "zndb": (
        ...
        SmartLifeSensorEntityDescription(
            key=DPCode.ENERGY_FORWARD_A,
            name="Channel A energy forward",
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
            native_unit_of_measurement=UnitOfPower.KILO_WATT_HOUR,
        ),
        SmartLifeSensorEntityDescription(
            key=DPCode.ENERGY_REVERSE_A,
            name="Channel A energy reverse",
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
            native_unit_of_measurement=UnitOfPower.KILO_WATT_HOUR,
        ),
        ...
        SmartLifeSensorEntityDescription(
            key=DPCode.ENERGY_FORWARD_B,
            name="Channel B energy forward",
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
            native_unit_of_measurement=UnitOfPower.KILO_WATT_HOUR,
        ),
        SmartLifeSensorEntityDescription(
            key=DPCode.ENERGY_REVERSE_B,
            name="Channel B energy reverse",
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
            native_unit_of_measurement=UnitOfPower.KILO_WATT_HOUR,
        ),
